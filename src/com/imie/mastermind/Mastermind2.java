...
public class Mastermind2 {
	...
	public static void mastermind(int n, int nbTentativesMax)
	{
		int[] combinaison = new int[n];
		int[] copieCombinaison = new int[n];
		int[] proposition = new int[n];
		int bienPlaces, malPlaces, nbTentatives;
		...
		do
		{
			...
			combinaison = combinaisonAleatoire(n);
			...
			do
			{
				...
				copieCombinaison = recopieTableau(combinaison);
	...
	/**
	 * Fonction qui compte le nombre de chiffres bien places
	 ...
	 */
	public static int bienPlaces(int[] combinaison, int[] proposition, int [] combinaisonModifiee)
	{
		int bienPlaces = 0;
	...
	/**
	 * Fonction qui renvoie le nombre de mal places. Attention a appeler cette fonction avec les tableaux qui contiennent les 0
	 ...
	 */
	public static int malPlaces(int [] combinaisonModifie, int [] propositionModifie)
	{
	 ...
	 */
	public static int[] combinaisonAleatoire(int n)
	{
		int [] combi = new int [n];
	 ...
	 */
	public static int saisirEntierEntre0Et8(int n)
	{		
	 ...
	 */
	public static boolean saisirProposition(int n, int[] proposition)
	{
		boolean quit = false;
		int i=0;
		...
		while(!quit && i<n)
		{
			proposition[i] = saisirEntierEntre0Et8(i+1);
	 ...
	 */
	public static int[] recopieTableau(int [] tableau)
	{
	 ...
	 */
	public static void afficheResultat(int b, int m)
	{
